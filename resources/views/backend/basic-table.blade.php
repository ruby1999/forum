        ...
        <div class="table-responsive">
          <table class="table table-striped">
            ...
            <tbody>
              <tr>
                <td class="py-1">
                  <img src="{{ url('asset/images/faces-clipart/pic-1.png') }}" alt="image" /> </td>
                <td> Herman Beck </td>
                <td>
                  <div class="progress">
              ...
              <tr>
                <td class="py-1">
                  <img src="{{ url('asset/images/faces-clipart/pic-2.png') }}" alt="image" /> </td>
                <td> Messsy Adam </td>
                <td>
                  <div class="progress">
              ...
              <tr>
                <td class="py-1">
                  <img src="{{ url('asset/images/faces-clipart/pic-3.png') }}" alt="image" /> </td>
                <td> John Richards </td>
                <td>
                  <div class="progress">
              ...
              <tr>
                <td class="py-1">
                  <img src="{{ url('asset/images/faces-clipart/pic-4.png') }}" alt="image" /> </td>
                <td> Peter Meggik </td>
                <td>
                  <div class="progress">
