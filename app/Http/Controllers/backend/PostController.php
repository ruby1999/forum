...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        //自動分頁的方法
        $posts = Product::orderBy('id', 'asc')->paginate(5);
    ...
    public function showList()
    {
        ...
        //自動分頁的方法
        $posts = Product::orderBy('id', 'asc')->paginate(5);
        return view('frontend.posts.list')->withPosts($posts)->withCategories($categories)->withTags($tags);
    }
    ...
    public function create()
    {
        $categories = Category::all();
        $tags = Tag::all();
        return view('backend.posts.create')->withPosts($categories)->withCategories($categories)->withTags($tags);
    }
    ...
    public function store(Request $request)
    {
        ...
        $post = new Product; //要引用App\Product;
